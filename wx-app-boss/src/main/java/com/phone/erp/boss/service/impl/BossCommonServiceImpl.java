...
/*		//第二步设置分页参数
	 ...
	 */
	@Override
	public void putSectionListInCompany(LoginEmployeeVo employeeVo,
			List<BossCompanyVo> dataList) {
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("employeeId", employeeVo.getId());
		map.put("groupId", employeeVo.getGroupId());
	 ...
	 * @author hmj
	 * @param map
	 *            [employeeId,groupId,companyId,kcFalg]
	 ...
	 * @throws Exception 
	 */
	public Map<String, Object> putCompanySectionInMap(LoginEmployeeVo employeeVo,String menuCode,
			Map<String, Object> map,String companySectionParam) throws Exception {
		List<BossSectionVo> sectionList = new ArrayList<BossSectionVo>();
	...
	public Map<String,Object> getParamMap(BossQueryVo queryVo) throws Exception{
		...
		map = putCompanySectionInMap(employeeVo,queryVo.getMenuCode(),
				map,queryVo.getCompanySectionParam());
		//设置page 和pageSize 如果为空 给默认 1和20
		if(null==queryVo.getPage()){queryVo.setPage(1);}
		if(null==queryVo.getPageSize()){queryVo.setPageSize(20);}
		//设置是否禁用参数
